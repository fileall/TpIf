<?php /*a:1:{s:47:"D:\gitdata\TpIf\app\admin\view\login\index.html";i:1591872101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>LEMO后台管理-登陆</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="csrf-token" content="<?php echo htmlentities($token); ?>">
    ...
    <style>
        ...
        .login-form {background-color:#00111C;border:1px solid #fff;border-radius:7px;padding:14px 20px;box-shadow:0 0 12px #3FBEEB;}
        ...
        .login-bg {
            background-image: url(/static/admin/images/bg-logo.jpg);
        }
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img  id="captchaPic" src="<?php echo url('captcha'); ?>" alt="captcha" onclick="this.src='<?php echo url("captcha"); ?>?'+'id='+Math.random()"/>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="copyright">
                    © 2018-2020 <a href="" >tpif.com</a> All Rights Reserved.
                </div>
            </form>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success:function (res) { console.log(res);
                    if(res.status>0){
                        ...
                        layer.msg(res.msg);
                        $('#captchaPic').attr('src','<?php echo url("captcha"); ?>?id='+Math.random());
                        return false;
                    }
