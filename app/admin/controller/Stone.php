...
//        foreach($this->bindConst as $k=>$v){
//            $this->$k = $v;
//        }

//        parent::__construct(App::class); // TODO: Change the autogenerated stub
        //判断管理员是否登录
...
//        $this->authCheck();
     ...
     * @return mixed
     */
    public function get($bindConst)
    {
        if ($this->bindConst[$bindConst]) {
            return $this->bindConst[$bindConst];
        }
        throw new ClassNotFoundException('class not exists: ' . $bindConst, $bindConst);
    }
