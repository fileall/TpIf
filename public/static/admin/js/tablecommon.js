        ...
        switch (obj.event) {
            ...
            case 'window':
                ...
                var open = {
                    ...
                    area: [(data.width || 600) + 'px', (data.height || 350) + 'px'], maxmin: data.maxmin || true, success: function (e, i) {
                ...
                if (data.btn) {
                    ...
                    open.yes = function (index, layero) {
                        var iframeWin = window[layero.find('iframe')[0]['name']];//console.log(data.callback);console.log(iframeWin);
                        if (data.callback) {
