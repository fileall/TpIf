...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    I.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            /*私自改动layui判断tablePage_1存在则第一页传值渲染，而不再次请求*/
            var ta = a.tablePage_1;
            if (ta && ta != '') {
                ta[n.statusName] != n.statusCode ? (i.renderForm(), i.layMain.html('<div class="' + f + '">' + (ta[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(ta, e, ta[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof a.done && a.done(ta, e, ta[n.countName]);
                a.tablePage_1 = '';
            } else {
                t.ajax({
                    type: a.method || "get",
        ...
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("index.html"),
                o = a.layBody.find('tr[data-index="' + n + '"]'), r = d.cache[a.key] || [];
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("index.html"), n = e[0].checked,
            ...
            var e = t(this).prev(), i = e[0].checked, l = d.cache[a.key], n = e.parents("tr").eq(0).data("index.html");
        ...
        a.layBody.on("change", "." + W, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"), n = e.parents("tr").eq(0).data("index.html"),
                o = d.cache[a.key][n];
            o[l] = i, layui.event.call(this, y, "edit(" + p + ")", v.call(this, {value: i, field: l}))
        }).on("blur", "." + W, function () {
            var e, l = t(this), n = this, o = l.parent().data("field"), r = l.parents("tr").eq(0).data("index.html"),
                c = d.cache[a.key][r];
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            var e = t(this), i = e.parents("tr").eq(0).data("index.html");
