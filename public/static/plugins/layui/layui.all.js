...
layui.define("jquery", function (e) {
    ...
    D.prototype.config = {
        ...
        i(c)[0] && i(c).data("index.html") == e.index ? e.removePicker(D.thisElemInd) : (e.removePicker(D.thisElemInd), i("body").append(t)), D.thisElemInd = e.index, D.thisColor = r.style.background, e.position(), e.pickerEvents()
...
layui.define(["laytpl", "form"], function (e) {
    ...
    x.prototype.config = {
        ...
        e.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
            ...
            var n = a(this), i = n.data("index.html"), l = e.layBox.eq(i), r = [];
            if (!n.hasClass(o)) {
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    I.prototype.config = {
        ...
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("index.html"), o = a.layBody.find('tr[data-index="' + n + '"]'),
                r = d.cache[a.key] || [];
